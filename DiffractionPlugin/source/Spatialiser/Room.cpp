...
namespace UIE
{
	...
	namespace Spatialiser
	{
		...
		//				{
		//					lock_guard<std::mutex> lock(mEdgeMutex);
		//					UpdateEdge(IDs[0], itA->second, itB.second);
		//					/*if (!valid)
		//					{
		//						itA->second.RemoveEdge(IDs[0]);
		//						RemoveEdge(IDs[0], itA->first);
		//					}*/
		//				}
		//				else if (IDs.size() > 1)
		//				{
		//					UpdateEdges(IDs[0], itA->second, itB.second);
		//				}
		//				else
		//				{
		...
		//					{
		//						auto it = mEdges.find(id);
		//						if (it == mEdges.end()) { } // case: edge does not exist
		//						else // case: wall does exist
		//						{ 
		//							it->second.Update(verticesA[i], verticesA[idxA], a.GetNormal(), b.GetNormal());
		//							return;
		//						} 
		//					}
		//					else
		...
		//						else // case: wall does exist
		//						{ 
		//							it->second.Update(verticesA[i], verticesA[idxA], b.GetNormal(), a.GetNormal());
		//							return;
		//						}
		//					}
		//				}
