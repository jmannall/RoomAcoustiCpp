...
It is based on precomputed data [generated by analyzing the acoustic environment](https://github.com/Matteo-Scerbo/MoD-ART/).
...
More information about the workings of MoD-ART can be found [here](https://github.com/Matteo-Scerbo/MoD-ART/blob/master/ART_theory.md).
