...
#ifndef DSP_GraphicEQ_private_h
#define DSP_GraphicEQ_private_h
		...
		*/
		...
		private:
			...
			*/
			...
			std::unique_ptr<PeakLowShelf<T>> lowShelf;							// Low-shelf filter
			std::vector<std::unique_ptr<PeakingFilter<T>>> peakingFilters;		// Peaking filters
			std::unique_ptr<PeakHighShelf<T>> highShelf;						// High-shelf filter
