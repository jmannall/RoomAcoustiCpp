...
EIGEN_DEVICE_FUNC inline RealScalar SquaredNormal() const { return squaredNorm(); }
EIGEN_DEVICE_FUNC inline RealScalar Normal() const { return norm(); }
EIGEN_DEVICE_FUNC inline const PlainObject Normalised() const { return normalized(); }
...
EIGEN_DEVICE_FUNC inline const Inverse<Derived> InverseMatrix() const { return inverse(); }
